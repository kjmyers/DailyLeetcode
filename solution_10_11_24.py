    ...
    def smallestChair(self, times: List[List[int]], targetFriend: int) -> int:
        ...
        for event in events:
            ...
            while occupied_chairs and occupied_chairs[0][0] <= time:
                _, chair = heapq.heappop(occupied_chairs)  # Pop chair that becomes empty
            ...
            if friend >= 0:
                ...
                if friend == targetFriend:
                    return chair
                heapq.heappush(occupied_chairs, [times[friend][1], chair])  # chair will be occupied till this time
