class Solution:
    ...
    def trapRainWater(self, height_map):
        ...
        for i in range(num_of_rows):
            ...
            heapq.heappush(boundary, self.Cell(height_map[i][num_of_cols - 1], i, num_of_cols - 1))
        ...
        for i in range(num_of_cols):
            ...
            heapq.heappush(boundary, self.Cell(height_map[num_of_rows - 1][i], num_of_rows - 1, i))
        ...
        while boundary:
            ...
            for direction in range(4):
                ...
                if (
                    self._is_valid_cell(neighbor_row, neighbor_col, num_of_rows, num_of_cols)
